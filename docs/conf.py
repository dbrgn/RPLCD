...
project = 'RPLCD'
copyright = '2013-2017, Danilo Bargen'
...
latex_documents = [
  ('index', 'RPLCD.tex', 'RPLCD Documentation',
   'Danilo Bargen', 'manual'),
]
...
man_pages = [
    ('index', 'rplcd', 'RPLCD Documentation',
     ['Danilo Bargen'], 1)
]
...
texinfo_documents = [
  ('index', 'RPLCD', 'RPLCD Documentation',
   'Danilo Bargen', 'RPLCD', 'One line description of project.',
   'Miscellaneous'),
]
