...
if sys.argv[1] == 'i2c':
    ...
    if len(sys.argv) != 3:
        print_usage()
    lcd = gpio.CharLCD(cols=40, rows=2, charmap=sys.argv[2])
else:
    print_usage()
...
lcd.clear()
lcd.write_string('This text will wrap around both lines from 0,0 to 0,39 and 1,0 to 1,39')
...
lcd.clear()
lcd.write_string('9994567890123456789012345678901234567890\n\r\n123')
input('The display should be "1234567890" 1to40')
